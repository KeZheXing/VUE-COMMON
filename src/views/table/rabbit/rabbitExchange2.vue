<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.costtype" :placeholder="$t('table.importance')" clearable class="filter-item" style="width: 180px">
      ...
      >
        ...
        <el-table-column :label="$t('table.cost')" width="150px" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column :label="$t('table.nickname')" width="150px" align="center">
          <template slot-scope="scope">
...
<script>
import { getExchange } from '@/api/costlog'
...
export default {
  ...
  data() {
    return {
      reset: '读取中',
      fileList: [],
      typelist: [{ 'key': undefined, 'display_name': '全部' }, { 'key': 'LOGIN', 'display_name': '登陆62' }, { 'key': 'PICKUP', 'display_name': '提取数据' }, { 'key': 'INVEST', 'display_name': '为下级充值' }],
