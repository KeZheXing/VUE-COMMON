<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-if="checkPermission(['ADMIN'])" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate2">添加代理</el-button>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          ...
          <el-button v-if="checkPermission(['ADMIN'])" size="mini" round @click="disable(scope.row.id)">{{ scope.row.isActive==false?"禁用":"启用" }}
          </el-button>
...
<script>
import { getExchange, invest, del, disable, createUser, createAgent, updateByp } from '@/api/member'
